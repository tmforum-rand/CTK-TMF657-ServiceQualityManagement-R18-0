...
Once Node.js and npm are installed download and unzip the CTK-TMF657-ServiceQualityManagement ZIP file within your test directory.
...
>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/serviceQualityManagement/v2/serviceLevelObjective

You should input:
>>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/serviceQualityManagement/v2/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF657-ServiceQualityManagement/blob/master/CTK-TMF657-ServiceQualityManagement/Output-Example.png)
