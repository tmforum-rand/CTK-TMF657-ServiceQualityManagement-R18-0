...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualityManagement/v2/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "serviceLevelObjective";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF657 ServiceQualityManagement\n");
getURL();
...
function getURL(){
    ...
    rl.question('////////////////////////////////////////////////////////////////////////\nWhat is your full API address omiting the endpoint? example:\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualityManagement/v2/serviceLevelObjective\nbecomes\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualityManagement/v2/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF657-ServiceQualityManagement.postman_collection.json'),
